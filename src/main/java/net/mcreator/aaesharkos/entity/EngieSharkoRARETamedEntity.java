...
import net.mcreator.aaesharkos.procedures.EngieSharkoRARETPProcedure;
...
public class EngieSharkoRARETamedEntity extends PathfinderMob {
	public EngieSharkoRARETamedEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AaeSharkosModEntities.ENGIE_SHARKO_RARE_TAMED.get(), world);
	}

	public EngieSharkoRARETamedEntity(EntityType<EngieSharkoRARETamedEntity> type, Level world) {
		super(type, world);
		maxUpStep = 0.6f;
		xpReward = 0;
		setNoAi(false);
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		EngieSharkoRARETPProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
