...
public class BigAlbinoSharkoEntity extends PathfinderMob {
	...
	public BigAlbinoSharkoEntity(EntityType<BigAlbinoSharkoEntity> type, Level world) {
		super(type, world);
		maxUpStep = 1f;
		xpReward = 0;
		setNoAi(false);
	...
	public static void init() {
		SpawnPlacements.register(AaeSharkosModEntities.BIG_ALBINO_SHARKO.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
