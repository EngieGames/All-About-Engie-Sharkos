...
public class OldMythicSharkoEntity extends TamableAnimal {
	public OldMythicSharkoEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AaeSharkosModEntities.OLD_MYTHIC_SHARKO.get(), world);
	}

	public OldMythicSharkoEntity(EntityType<OldMythicSharkoEntity> type, Level world) {
		super(type, world);
		maxUpStep = 0.6f;
		xpReward = 0;
		setNoAi(false);
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		OldMythicSharkoEntity retval = AaeSharkosModEntities.OLD_MYTHIC_SHARKO.get().create(serverWorld);
	...
	public boolean isFood(ItemStack stack) {
		return List.of(AaeSharkosModItems.GOLDEN_COOKIE.get()).contains(stack.getItem());
	}
