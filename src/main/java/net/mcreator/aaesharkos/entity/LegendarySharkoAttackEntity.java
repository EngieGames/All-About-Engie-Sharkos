...
public class LegendarySharkoAttackEntity extends PathfinderMob {
	public LegendarySharkoAttackEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AaeSharkosModEntities.LEGENDARY_SHARKO_ATTACK.get(), world);
	}

	public LegendarySharkoAttackEntity(EntityType<LegendarySharkoAttackEntity> type, Level world) {
		super(type, world);
		maxUpStep = 0.6f;
		xpReward = 0;
		setNoAi(false);
	...
	public void baseTick() {
		super.baseTick();
		LegendarySharkoPProcedure.execute(this.level, this.getX(), this.getY(), this.getZ(), this);
	}
