...
import net.mcreator.aaesharkos.procedures.EngieSharkoRARE2PProcedure;
import net.mcreator.aaesharkos.init.AaeSharkosModEntities;

public class EngieSharkoRARE2AttackEntity extends PathfinderMob {
	public EngieSharkoRARE2AttackEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AaeSharkosModEntities.ENGIE_SHARKO_RARE_2_ATTACK.get(), world);
	}

	public EngieSharkoRARE2AttackEntity(EntityType<EngieSharkoRARE2AttackEntity> type, Level world) {
		super(type, world);
		maxUpStep = 0.6f;
		xpReward = 0;
		setNoAi(false);
	...
	public void baseTick() {
		super.baseTick();
		EngieSharkoRARE2PProcedure.execute(this.level, this.getX(), this.getY(), this.getZ(), this);
	}
