...
import net.mcreator.aaesharkos.procedures.EngieSharkoRARESPProcedure;
...
public class EngieSharkoRAREStayEntity extends PathfinderMob {
	public EngieSharkoRAREStayEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AaeSharkosModEntities.ENGIE_SHARKO_RARE_STAY.get(), world);
	}

	public EngieSharkoRAREStayEntity(EntityType<EngieSharkoRAREStayEntity> type, Level world) {
		super(type, world);
		maxUpStep = 0.6f;
		xpReward = 0;
		setNoAi(false);
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		EngieSharkoRARESPProcedure.execute(world, x, y, z, entity);
		return retval;
	}
