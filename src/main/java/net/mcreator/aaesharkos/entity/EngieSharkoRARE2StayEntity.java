...
import net.mcreator.aaesharkos.procedures.EngieSharkoRARE2SPProcedure;
import net.mcreator.aaesharkos.init.AaeSharkosModEntities;

public class EngieSharkoRARE2StayEntity extends PathfinderMob {
	public EngieSharkoRARE2StayEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AaeSharkosModEntities.ENGIE_SHARKO_RARE_2_STAY.get(), world);
	}

	public EngieSharkoRARE2StayEntity(EntityType<EngieSharkoRARE2StayEntity> type, Level world) {
		super(type, world);
		maxUpStep = 0.6f;
		xpReward = 0;
		setNoAi(false);
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		EngieSharkoRARE2SPProcedure.execute(world, x, y, z, entity);
		return retval;
	}
