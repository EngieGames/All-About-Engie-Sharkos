...
import net.mcreator.aaesharkos.procedures.EngieSharkoRARE2TPProcedure;
import net.mcreator.aaesharkos.init.AaeSharkosModEntities;

public class EngieSharkoRARE2TamedEntity extends PathfinderMob {
	public EngieSharkoRARE2TamedEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AaeSharkosModEntities.ENGIE_SHARKO_RARE_2_TAMED.get(), world);
	}

	public EngieSharkoRARE2TamedEntity(EntityType<EngieSharkoRARE2TamedEntity> type, Level world) {
		super(type, world);
		maxUpStep = 0.6f;
		xpReward = 0;
		setNoAi(false);
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		EngieSharkoRARE2TPProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
