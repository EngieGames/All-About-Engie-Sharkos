...
public class LegendarySharkoTPProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity, Entity sourceentity) {
		...
		if ((sourceentity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == Items.WOODEN_SWORD) {
			if (world instanceof ServerLevel _level) {
				Entity entityToSpawn = new LegendarySharkoAttackEntity(AaeSharkosModEntities.LEGENDARY_SHARKO_ATTACK.get(), _level);
			...
			if (world instanceof ServerLevel _level) {
				Entity entityToSpawn = new LegendarySharkoStayEntity(AaeSharkosModEntities.LEGENDARY_SHARKO_STAY.get(), _level);
				entityToSpawn.moveTo(x, y, z, entity.getYRot(), entity.getXRot());
				entityToSpawn.setYBodyRot(entity.getYRot());
				entityToSpawn.setYHeadRot(entity.getYRot());
				if (entityToSpawn instanceof Mob _mobToSpawn)
