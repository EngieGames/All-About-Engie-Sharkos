...
import net.mcreator.aaesharkos.procedures.EnchantedExoticCookiePlayerFinishesUsingItemProcedure;
...
public class EnchantedExoticCookieItem extends Item {
	...
	public ItemStack finishUsingItem(ItemStack itemstack, Level world, LivingEntity entity) {
		...
		EnchantedExoticCookiePlayerFinishesUsingItemProcedure.execute(entity);
		return retval;
	}
}
